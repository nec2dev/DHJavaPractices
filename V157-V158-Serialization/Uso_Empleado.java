...
public class Uso_Empleado {
	...
	public static void main(String[] args) {
		...
		Empleado empleado3=new Empleado("Mariana Mart�nez" , 105000, 2002, 03, 15);
		...
		misEmpleados[2]= new Empleado("Mariana Mart�nez", 105000, 2002, 03, 15);
		
		misEmpleados[3]= new Empleado("Antonio Fern�ndez");
		
		misEmpleados[4]=jefe_RRHH; //polimorfismo en accion. Principio de sustituci�n
